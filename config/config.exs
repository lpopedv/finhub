...
config :finhub_web, FinhubWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: FinhubWeb.ErrorHTML, json: FinhubWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Core.PubSub,
  live_view: [signing_salt: "dQYKOEt/"]
...
config :esbuild,
  ...
  finhub_web: [
    ...
    cd: Path.expand("../apps/finhub_web/assets", __DIR__),
...
config :tailwind,
  ...
  finhub_web: [
    ...
    cd: Path.expand("../apps/finhub_web", __DIR__)
  ]
